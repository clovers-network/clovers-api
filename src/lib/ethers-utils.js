...
let clubTokenInstance = new ethers.Contract(clubTokenAddress, clubTokenABI, provider)
...
let cloversControllerAddress = CloversController.networks[config.networkId].address
let cloversControllerInstance = new ethers.Contract(cloversControllerAddress, cloversControllerABI, provider)
let _cloversController = web3.eth.contract(cloversControllerABI)
let cloversControllerWeb3Instance = _cloversController.at(cloversControllerAddress)
...
export let events = {
  'Clovers': {
    ...
    eventTypes: ['Transfer', 'Approval', 'ApprovalForAll', 'OwnershipTransferred']
  },
  'ClubToken':{
    abi: clubTokenABI,
  ...
  'CloversController': {
    ...
    eventTypes: ['cloverCommitted', 'cloverClaimed', 'stakeAndRewardRetrieved', 'cloverChallenged', 'OwnershipTransferred']
  }
}